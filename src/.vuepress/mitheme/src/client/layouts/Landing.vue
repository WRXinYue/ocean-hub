    ...
    <div class="body">
      ...
      <!-- <div class="supporters">
        <div class="container">
          ...
          /></a>
          <a style="display: block" class="skeb" title="Skeb" href="https://skeb.jp/" target="_blank"
            ><img src="/sponsors/skeb.svg" alt="Skeb" style="width: 180px"
          /></a>
          <a
            style="display: block"
            class="dcadvirth"
            title="DC Advirth"
            href="https://www.dotchain.ltd/advirth"
            target="_blank"
...
onMounted(() => {
  ...
  window.setTimeout(() => {
    ...
    for (let i = 0; i < (tagline as any).children.length; i++) {
      const row = (tagline as any).children[i]
      window.setTimeout(() => {
