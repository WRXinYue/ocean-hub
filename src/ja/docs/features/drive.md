# ドライブ
ドライブは、Ocean上でファイルを管理できる機能です。

::: tip
技術的に言うと、Oceanのシステム上、すべてのファイルが一元管理されており、それをユーザーにも公開したインターフェイスがドライブと捉えることができます。
:::

Ocean Webのドライブページから任意のファイルをアップロードできるほか、アバターに設定した画像や、ノートに添付したファイルなどもすべてドライブにアップロードされます。
