import{_ as n,o as s,c as a,e}from"./app.8829780d.js";const i={},t=e(`<h1 id="nginx-configuration" tabindex="-1"><a class="header-anchor" href="#nginx-configuration" aria-hidden="true">#</a> Nginx configuration</h1><ol><li>Create <code>/etc/nginx/conf.d/ocean.conf</code> or <code>/etc/nginx/sites-available/ocean.conf</code> and copy the following example to the file.<br> (The file name does not have to be &quot;ocean&quot;.)</li><li>Edit as follows: <ol><li>Replace example.tld with the domain you have prepared.<br><code>ssl_certificate</code> and <code>ssl_certificate_key</code> should be the path to the certificate obtained from Let&#39;s Encrypt.</li><li>If using a CDN such as Cloudflare, remove 4 lines from &quot;If it&#39;s behind another reverse proxy or CDN, remove the following.&quot;</li></ol></li><li>If you create <code>/etc/nginx/sites-available/ocean.conf</code>, create symlink as <code>/etc/nginx/sites-enabled/ocean.conf</code>.<br><code>sudo ln -s /etc/nginx/sites-available/ocean.conf /etc/nginx/sites-enabled/ocean.conf</code></li><li>Run <code>sudo nginx -t</code> to verify that the configuration file will be loaded successfully.</li><li>Run <code>sudo systemctl restart nginx</code> to restart nginx.</li></ol><h1 id="nginx-config-example" tabindex="-1"><a class="header-anchor" href="#nginx-config-example" aria-hidden="true">#</a> Nginx config example</h1><div class="language-nginx ext-nginx line-numbers-mode"><pre class="language-nginx"><code><span class="token comment"># For WebSocket</span>
...
<span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),c=[t];function o(l,p){return s(),a("div",null,c)}var r=n(i,[["render",o],["__file","nginx.html.vue"]]);export{r as default};
