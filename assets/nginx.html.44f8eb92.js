import{_ as i,r as t,o as c,c as o,a as n,d as s,b as l,w as p,e as a}from"./app.e2d673e1.js";const d={},r=n("h1",{id:"configurazione-di-nginx",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#configurazione-di-nginx","aria-hidden":"true"},"#"),s(" Configurazione di Nginx")],-1),u=n("li",null,[s("Crea il file "),n("code",null,"/etc/nginx/conf.d/misskey.conf"),s(" oppure "),n("code",null,"/etc/nginx/sites-available/misskey.conf"),s(" copiaci dentro il contenuto dell'esempio. (il nome del file pu\xF2 cambiare)")],-1),k=n("li",null,[s("Sostituisci "),n("code",null,"example.tld"),s(" col nome del tuo dominio."),n("br"),n("code",null,"ssl_certificate"),s(" e "),n("code",null,"ssl_certificate_key"),s(" dovrebbero essere i percorsi ai file ottenuti con Let's Encrypt.")],-1),v=a("<li>Se hai creato il file <code>/etc/nginx/sites-available/misskey.conf</code>, crea anche il symlink <code>/etc/nginx/sites-enabled/misskey.conf</code> usando il seguente comando:<br><code>sudo ln -s /etc/nginx/sites-available/misskey.conf /etc/nginx/sites-enabled/misskey.conf</code></li><li>Esegui <code>sudo nginx -t</code> per verificare che la configurazione sia ok.</li><li>Esegui <code>sudo systemctl restart nginx</code> per ricaricare Nginx.</li>",3),m=a(`<h1 id="esempio-di-configurazione-nginx" tabindex="-1"><a class="header-anchor" href="#esempio-di-configurazione-nginx" aria-hidden="true">#</a> Esempio di configurazione Nginx</h1><div class="language-nginx ext-nginx line-numbers-mode"><pre class="language-nginx"><code><span class="token comment"># For WebSocket</span>
...
<span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function b(_,y){const e=t("RouterLink");return c(),o("div",null,[r,n("ol",null,[u,n("li",null,[s("Modifica come segue: "),n("ol",null,[k,n("li",null,[s("Se usi una "),l(e,{to:"/it/docs/admin/cdn.html"},{default:p(()=>[s("CDN come Cloudflare")]),_:1}),s(`, elimina 4 linee partendo da: "If it's behind another reverse proxy or CDN, remove the following."`)])])]),v]),m])}var f=i(d,[["render",b],["__file","nginx.html.vue"]]);export{f as default};
